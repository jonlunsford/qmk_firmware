...
[_QW] = { /* Qwerty */
  ...
  {M(0),    KC_LALT, KC_LCTL, KC_LGUI, MO(_LW), KC_SPC,  KC_SPC,  MO(_RS), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
[_RS] = { /* RAISE */
  {KC_GRV,  KC_1,    KC_2,    KC_3,     KC_4,     KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS},
  {KC_TRNS, KC_UNDO, KC_CUT,  KC_COPY,  KC_PASTE, KC_TRNS, KC_WREF, KC_TRNS, KC_TRNS, KC_TRNS, RESET,   KC_TRNS},
